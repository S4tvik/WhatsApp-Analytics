...
Original file is located at
    https://colab.research.google.com/drive/1Wj-Y8ErdPpIv8vRrIAg2KbYuzIkZcV2Z
"""
...
fig.show()
# fig.write_image('templates/fig1.png')
...
fig.show()
# fig.write_image('templates/fig2.png')
...
fig.show()
# fig.write_image('templates/fig3.png')
...
fig.show()
# fig.write_image('templates/fig4.png')
...
fig.show()
# fig.write_image('templates/fig5.png')
...
fig.show()
# fig.write_image('templates/fig6.png')
...
for i in neu:
  final_sentiments.append(i)
def result(final_sent):
  text = "Top 5 Positive statements are:\n" + final_sent[0]+"\n" + final_sent[1]+"\n"+ final_sent[2]+"\n"+ final_sent[3]+"\n"+ final_sent[4]+"\n\n\n\n"+"Top 5 Negative statements are:\n" + final_sent[5]+"\n" + final_sent[6]+"\n"+ final_sent[7]+"\n"+ final_sent[8]+"\n"+ final_sent[9]+"\n\n\n\n"+"Top 5 Positive statements are:\n" + final_sent[10]+"\n" + final_sent[11]+"\n"+ final_sent[12]+"\n"+ final_sent[13]+"\n"+ final_sent[14]+"\n\n\n\n"
  return text

df2

# df2['Dates'] = pd.to_datetime(df['dates']).dt.date
# df2['Time'] = pd.to_datetime(df['dates']).dt.time

# df2['Dates'] = pd.to_datetime(df['dates'].dt.strftime('%Y-%m-%d'))
# df2['Time'] = pd.to_datetime(df['dates']).dt.time

# df2['Dates'] = df2['Dates'].dt.date

# dtt = datetime.strptime('2022-10-04','%Y-%m-%d')
